...
const Postat = () => {
    ...
    useEffect(() => {
        ...
        fetchItems('https://grez-shop.vercel.app/api/fann/', setItems2, 'fann');
        fetchItems('https://grez-shop.vercel.app/api/tiktok/', setItems3, 'tiktok');
    }, []);
    ...
    return (
        <div className={styles.container}>
            {/* Form 1: PUBG */}
            <form onSubmit={(e) => isEditing ? updateTikTokItem(e, 'https://grez-shop.vercel.app/api/pubg/postt/', setItems1) : handleFormSubmit(e, form1, setForm1, 'https://grez-shop.vercel.app/api/pubg/postt', setItems1)} className={styles.form}>
            ...
            {/* Form 3: Tiktok */}
            <form onSubmit={(e) => isEditing ? updateTikTokItem3(e, 'https://grez-shop.vercel.app/api/tiktok/postt/', setItems3) : handleFormSubmit(e, form3, setForm3, 'https://grez-shop.vercel.app/api/tiktok/postt', setItems3)} className={styles.form}>
                <div {...getRootProps()} className={styles.dropzone}>
                    <input {...getInputProps()} />
                    {isDragActive ? <p>Dosyayı buraya bırakın...</p> : <p>Fotoğraf yüklemek için tıklayın veya sürükleyin.</p>}
                </div>
                    ...
                    <ul>
                        {items3.map((item) => (
                            <li key={item._id} className={styles.item}>
                                ...
                                <button
                                    onClick={() => handleDelete(item._id, 'https://grez-shop.vercel.app/api/tiktok/', setItems3)}
                                    className={styles.deleteButton}
                                >
                                    <FontAwesomeIcon icon={faTrash} />
                                </button>
            ...
            {/* Form 2: Fann */}
            <form onSubmit={(e) => isEditing ? updateTikTokItem2(e, 'https://grez-shop.vercel.app/api/fann/postt/', setItems2) : handleFormSubmit(e, form2, setForm2, 'https://grez-shop.vercel.app/api/fann/postt', setItems2)} className={styles.form}>
                <div {...getRootProps()} className={styles.dropzone}>
                    <input {...getInputProps()} />
                    {isDragActive ? <p>Dosyayı buraya bırakın...</p> : <p>Fotoğraf yüklemek için tıklayın veya sürükleyin.</p>}
                </div>
                    ...
                    <ul>
                        {items2.map((item) => (
                            <li key={item._id} className={styles.item}>
                                ...
                                <button
                                    onClick={() => handleDelete(item._id, 'https://grez-shop.vercel.app/api/fann/', setItems2)}
                                    className={styles.deleteButton}
                                >
                                    <FontAwesomeIcon icon={faTrash} />
                                </button>
